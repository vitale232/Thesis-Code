...
gdalwarp -t_srs '+proj=utm +zone=11 +datum=WGS84 +units=m +no_defs' \
         -te 715826.8 4288532 754724.2 4331252 \
	 -r bilinear merged_dem.tif merged_UTM11.tif
...
export LOCATION='/home/vitale232/Documents/GrassGISdata/SnakeRange2/PERMANENT'
export GISDBASE='/home/vitale232/Documents/GrassGISdata'
export LOCATION_NAME='SnakeRange2'
export MAPSET='PERMANENT'

# Export the job as an environment variable
GRASS_BATCH_JOB=/home/vitale232/Google\ Drive/UNR/UNR-Thesis/Data/Thesis-Code/grass_work.sh
export GRASS_BATCH_JOB

#####################################################
# Call the grass executable
#####################################################
grass64 - /home/vitale232/Google\ Drive/UNR/UNR-Thesis/Data/Thesis-Code/grass_work.sh
