...
#### Clip and reproject
gdalwarp -t_srs '+proj=utm +zone=11 +datum=WGS84 +units=m +no_defs' -r bilinear -te 715826.8 4288532 754724.2 4331252 merged_dem.tif merged_UTM11_bilinear.tif
...
r.in.gdal input=merged_UTM11_bilinear.tif output=elevation_raster
...
r.out.gdal input=elevation_raster.tci format=GTiff \
      output=/home/vitale232/Google\ Drive/UNR/UNR-Thesis/Data/GIS-Data/TCI_Whole-Range_UTM_bilinear.tif
