...
stations[
  which(stations$station == 'sagebrush_west'), 'NevCAN Tmn'] = mean(
    nevcan[which(nevcan$month == 'Dec'), 'sage_west_tmn']) 

stations[
  which(stations$station == 'pj_west'), 'NevCAN Tmn'] = mean(
    nevcan[which(nevcan$month == 'Dec'), 'pj_west_tmn']) 

stations[
  which(stations$station == 'montane_west'), 'NevCAN Tmn'] = mean(
    nevcan[which(nevcan$month == 'Dec'), 'montane_west_tmn']) 

stations[
  which(stations$station == 'subalpine_west'), 'NevCAN Tmn'] = mean(
...
stations[
  which(stations$station == 'sagebrush_west'), 'NevCAN Tmx'] = mean(
    nevcan[which(nevcan$month == 'Jul'), 'sage_west_tmx']) 

stations[
  which(stations$station == 'pj_west'), 'NevCAN Tmx'] = mean(
    nevcan[which(nevcan$month == 'Jul'), 'pj_west_tmx']) 

stations[
  which(stations$station == 'montane_west'), 'NevCAN Tmx'] = mean(
    nevcan[which(nevcan$month == 'Jul'), 'montane_west_tmx']) 

stations[
  which(stations$station == 'subalpine_west'), 'NevCAN Tmx'] = mean(
